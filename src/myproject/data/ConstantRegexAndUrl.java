...
public class ConstantRegexAndUrl {
    ...
    public static final String REGEXFULLNAME ="^[a-zA-Z]{4,}(?: [a-zA-Z]+){0,2}$";
    public static final String REGEXNAME ="\\w{6,50}$";
    public static final String REGEXBOOKQUANTITY ="^[^0]\\d*";
    ...
    public static final String REGEXDATE ="^([0-9]{2})/([0-9]|10|11|12)/([0-9]{4})$";
